...
style_label                     = Pack(text_align=LEFT, padding_left=5, padding_right=5, color=FARBE_DUNKEL)
style_label_hell                = Pack(text_align=LEFT, padding_left=5, padding_right=5, color=FARBE_HELL)
