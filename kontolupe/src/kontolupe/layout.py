...
style_label_input_noflex        = Pack(padding=5, text_align=LEFT, color=FARBE_DUNKEL)
style_label_input_hell_noflex   = Pack(padding=5, text_align=LEFT, color=FARBE_HELL)
...
style_table_offene_buchungen    = Pack(flex=1, padding=5, color=FARBE_DUNKEL, height=200)
...
style_box_part_button           = Pack(direction=COLUMN, alignment=CENTER, padding_top=20, padding_bottom=20, background_color=FARBE_GRAU)
style_init_button               = Pack(padding=10, color=FARBE_DUNKEL)
style_box_headline              = Pack(direction=COLUMN, alignment=CENTER, background_color=FARBE_BLAU, padding_bottom=10)
style_label_subline             = Pack(font_size=14, font_weight='bold', text_align=CENTER, padding=5, padding_top=15, color=FARBE_DUNKEL)
style_label_subline_hell        = Pack(font_size=14, font_weight='bold', text_align=CENTER, padding=5, padding_top=15, color=FARBE_HELL)
